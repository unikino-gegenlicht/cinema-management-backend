...
func getRegisterSales(w http.ResponseWriter, r *http.Request) {
	// get the register id from the url
	rId := chi.URLParam(r, "registerId")
	registerID, err := primitive.ObjectIDFromHex(rId)
	if err != nil {
		w.WriteHeader(421)
	}
